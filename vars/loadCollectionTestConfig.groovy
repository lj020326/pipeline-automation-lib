...
//         log.error("config.gitRepoBranch is not set")
//         error("config.gitRepoBranch is not set")
//     }
//     String gitBranch = URLDecoder.decode(config.gitRepoBranch, "UTF-8")
    ...
    config.gitCommentPrefix = "JENKINS-${env.BUILD_ID}"
