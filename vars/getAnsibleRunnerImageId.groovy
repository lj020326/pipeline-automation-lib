 ...
 * - runnerRegistry (String, optional): docker registry uri (e.g., registry.example.int:5000)
 * - runnerImageName (String, optional): docker image name
 */
...
String call(Map args=[:]) {
    ...
    String runnerRegistry=args.get("runnerRegistry", "media.johnson.int:5000")
    String runnerImageName=args.get("runnerImageName", "ansible/ansible-test")
    ...
    return "${runnerRegistry}/${runnerImageName}:${tag}"
}
