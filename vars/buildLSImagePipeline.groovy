...
def call() {
    ...
    pipeline {
      ...
      environment {
        ...
        GIT_SIGNING_KEY=credentials('git-signing-key')
        ...
        DOCKER_IMAGE_SOURCE = "https://github.com/linuxserver/docker-calibre-web"
        IMAGE_SOURCE = "https://github.com/lj020326/calibre-web"
        IMAGE_SOURCE_DESCRIPTION = "[Calibre-web](${IMAGE_SOURCE}) is a web app providing a clean interface for browsing, reading and downloading eBooks using an existing Calibre database.   It is also possible to integrate google drive and edit metadata and your calibre library through the app itself.    This software is a fork of library and licensed under the GPL v3 License."
        IMAGE_DOC_URL = "https://docs.linuxserver.io/images/docker-calibre-web"
        DIST_IMAGE = 'ubuntu'
        MULTIARCH='true'
        CI='true'
        CI_WEB='true'
        ...
        stage('Build-Single') {
          ...
          steps {
            ...
            sh "docker buildx build \
              ...
              --label \"org.opencontainers.image.url=${DOCKER_IMAGE_SOURCE}/packages\" \
              --label \"org.opencontainers.image.documentation=${IMAGE_DOC_URL}\" \
              ...
              --label \"org.opencontainers.image.description=${IMAGE_SOURCE_DESCRIPTION}\" \
            ...
            stage('Build X86') {
              steps {
                ...
                sh "docker buildx build \
                  ...
                  --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
                  --label \"org.opencontainers.image.title=Calibre-web\" \
                  --label \"org.opencontainers.image.description=[Calibre-web](https://github.com/lj020326/calibre-web) is a web app providing a clean interface for browsing, reading and downloading eBooks using an existing Calibre database.   It is also possible to integrate google drive and edit metadata and your calibre library through the app itself.    This software is a fork of library and licensed under the GPL v3 License.  \" \
