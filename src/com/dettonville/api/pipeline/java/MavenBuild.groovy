...
class MavenBuild implements Serializable {
    ...
    com.dettonville.api.pipeline.java.model.MavenBuildInfo info;
     ...
     */
    MavenBuild(steps, com.dettonville.api.pipeline.utils.Maven maven, com.dettonville.api.pipeline.java.model.MavenBuildInfo mavenBuildInfo) {
        this.steps = steps
        this.maven = maven
