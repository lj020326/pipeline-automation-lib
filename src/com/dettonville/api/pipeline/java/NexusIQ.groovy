...
class NexusIQ implements Serializable {
    ...
    def steps
    com.dettonville.api.pipeline.java.model.MavenBuildInfo buildInfo
    com.dettonville.api.pipeline.utils.Maven maven
     ...
     */
    NexusIQ(steps, com.dettonville.api.pipeline.java.model.MavenBuildInfo buildInfo, com.dettonville.api.pipeline.utils.Maven maven, String nexusIqServer) {
        this.steps = steps
