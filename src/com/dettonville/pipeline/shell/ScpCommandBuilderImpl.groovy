 ...
 */
class ScpCommandBuilderImpl implements CommandBuilder, com.dettonville.pipeline.credentials.CredentialAware, ConfigAwareCommandBuilder, Serializable {
   ...
   * Credentials for SSH
   */
  com.dettonville.pipeline.credentials.Credential credentials
