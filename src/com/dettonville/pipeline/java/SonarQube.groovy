...
class SonarQube implements Serializable {
     ...
     */
    void sonarAnalysis(com.dettonville.pipeline.java.model.MavenBuildInfo mavenBuildInfo, com.dettonville.pipeline.utils.Utilities util, com.dettonville.pipeline.utils.Maven maven) {
