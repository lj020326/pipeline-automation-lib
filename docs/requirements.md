...
You can use the Ansible Role:
[dettonville-com-devops.dcapi-automation-pipeline](https://repo.dettonville.int/stash/projects/API/repos/ansible-dcapi-automation-pipeline)
