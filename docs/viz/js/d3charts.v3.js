...
function createCollapsibleIndentedTreeChart(treeData, chartDivName, in_width = 960, in_height = 500) {
    ...
    function collapseAll(){
        root.children.forEach(collapse1);
        collapse1(root);
        update(root);
    }
...
// ref: http://bl.ocks.org/robschmuecker/7880033
...
// ref: https://bl.ocks.org/swayvil/b86f8d4941bdfcbfff8f69619cd2f460
function collapsingTreeWithBoxes(urlService, jsonData)
{
	var urlService_ = '';
