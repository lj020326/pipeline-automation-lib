...
FILENAME="job-envvars.${QA_JOB_NUMBER}.${DATE}.json"
...
#JENKINS_JOB_URL="https://${JENKINS_URL}/${QA_JOB_FOLDER}/${QA_JOB_NUMBER}/injectedEnvVars/api/python"
JENKINS_JOB_URL="https://${JENKINS_URL}/${QA_JOB_FOLDER}/${QA_JOB_NUMBER}/injectedEnvVars"
...
curl -s -u ${JENKINS_CREDS} ${JENKINS_JOB_URL} 2>&1 | tee ${RPT_DIR}/${FILENAME}
