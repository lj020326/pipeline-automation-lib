...
# ref: https://github.com/wasilak/ansible-lint-junit/blob/master/src/ansible_lint_junit/main.py
import argparse
...
def main():
    ...
    if arguments.dummy:
        testsuite = ET.SubElement(
            testsuites, "testsuite", name="ansible-lint", errors=errors_count, failures="0", tests="0", time="0")

        ET.SubElement(testsuite, "testcase",
                      name="no linting errors found")
    else:
        testsuite = ET.SubElement(
            testsuites, "testsuite", name="ansible-lint", errors=errors_count, failures="0", tests=errors_count, time="0")
