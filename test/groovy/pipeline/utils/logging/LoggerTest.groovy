...
class LoggerTest extends DSLTestBase {
  ...
  void shouldLogObject() throws Exception {
    ...
    assertLogSize(6)
    assertEquals("[TRACE] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(0))
    assertEquals("[DEBUG] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(1))
    assertEquals("[INFO] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(2))
    assertEquals("[WARN] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(3))
    assertEquals("[ERROR] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(4))
    assertEquals("[FATAL] com.dettonville.pipeline.utils.logging.LoggerTest : my message -> (com.dettonville.pipeline.utils.logging.LoggerTest) " + this.toString(), getLogMessageAt(5))
  }
