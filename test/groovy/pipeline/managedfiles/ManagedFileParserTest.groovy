...
class ManagedFileParserTest extends DSLTestBase {
  ...
  com.dettonville.pipeline.utils.resources.JsonLibraryResource jsonLibraryResource
  Object testContent

  @Override
  void setUp() throws Exception {
    super.setUp()
    jsonLibraryResource = new com.dettonville.pipeline.utils.resources.JsonLibraryResource(this.dslMock.getMock(), "managedfiles/maven/parser-test.json")
