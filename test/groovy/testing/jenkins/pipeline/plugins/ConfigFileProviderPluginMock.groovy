 ...
 * #L%
 */
package com.dettonville.testing.jenkins.pipeline.plugins


import com.lesfurets.jenkins.unit.PipelineTestHelper
import com.dettonville.testing.jenkins.pipeline.EnvActionImplMock
import org.jenkinsci.plugins.configfiles.buildwrapper.ManagedFile
import org.junit.Assert

import static com.dettonville.testing.jenkins.pipeline.StepConstants.CONFIGFILE
import static com.dettonville.testing.jenkins.pipeline.StepConstants.CONFIGFILEPROVIDER
...
class ConfigFileProviderPluginMock {
  ...
  ConfigFileProviderPluginMock(PipelineTestHelper helper, com.dettonville.testing.jenkins.pipeline.recorder.StepRecorder stepRecorder, EnvActionImplMock envVars, String workSpaceTmp) {
    this.helper = helper
