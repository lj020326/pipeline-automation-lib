 ...
 * #L%
 */
package com.dettonville.testing.jenkins.pipeline.plugins.credentials


import com.lesfurets.jenkins.unit.PipelineTestHelper
import com.dettonville.testing.jenkins.pipeline.EnvActionImplMock

import static com.dettonville.testing.jenkins.pipeline.StepConstants.USERNAME_PASSWORD
import static com.dettonville.testing.jenkins.pipeline.StepConstants.WITH_CREDENTIALS
...
class CredentialsPluginMock {
  ...
  CredentialsPluginMock(PipelineTestHelper helper, com.dettonville.testing.jenkins.pipeline.recorder.StepRecorder stepRecorder, EnvActionImplMock envVars) {
    this.helper = helper
