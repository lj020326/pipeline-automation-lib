...
package com.dettonville.api.pipeline.tools.ansible
...
class RoleRequirementsTest extends DSLTestBase {
  ...
  void shouldParseRoles() {
    ...
    assertEquals("https://github.com/dettonville-com-devops/ansible-aem-cms.git", role3.getSrc())
    ...
    assertEquals("https://github.com/dettonville-com-devops/ansible-aem-service.git", role4.getSrc())
  ...
  void shouldCreateCorrectCheckoutConfigs() {
    ...
    Map expectedConfig2 = [
        (SCM): [
            (SCM_URL)       : "https://github.com/dettonville-com-devops/ansible-aem-service.git",
