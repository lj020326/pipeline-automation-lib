...
/**
 * Runs execMaven step with default configuration to test auto lookup for local maven settings only
 *
 * @return The script
 * @see vars.execMaven.ExecMavenIT
 */
def execute() {
  execMaven((SCM): [(SCM_URL): "https://subdomain.betterdomain.tld/group1/project2.git"])
}
