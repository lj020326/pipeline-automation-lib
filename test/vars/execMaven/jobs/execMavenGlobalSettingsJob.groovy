...
/**
 * Runs execMaven step with default configuration to test auto lookup for global maven settings only
 *
 * @return The script
 * @see vars.execMaven.ExecMavenIT
 */
def execute() {
  execMaven((SCM): [(SCM_URL): "https://subdomain.domain.tld/group/project1.git"])
}
