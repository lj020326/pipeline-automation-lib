...
def execute() {
  gitTools.mirrorRepository("git@gitrepository.dettonville.int/stash/scm/api/pipeline-automation-lib.git","https://gitrepository.dettonville.int/stash/scm/api/pipeline-automation-lib.git")
}
